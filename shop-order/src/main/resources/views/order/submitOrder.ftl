        ...
        <div id="s_bd">
            ...
            <form id="paymentForm" action="${ctx}/order/payment" method="post">
                ...
                <div class="osuccess">
                    ...
                    <p>我们讲为您保留订单2日，如果2日后EGO网仍未收到您的付款，我们将自动取 消此订单。<br/>商品预计到达时间：2011年11月06日，星期日，下午14:00-18:00，请您注意查收。</p>
                    <div class="ddinfo">
                        订单编号：${orderSn} <a class="blue" href="#">查看订单详情</a>
                        <br/>付款方式：在线支持 中国银行<br/>应付金额：<strong class="red">￥${totalAmount}</strong>
                    </div>
                    <p class="gopay">
