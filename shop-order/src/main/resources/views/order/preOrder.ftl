                        ...
                        <td class="summary">
                            <table class="catlist" width="100%">
                                ...
                                <#list cartResult.cartList as cartVo >
                                    <tr>
                                        <td><a href="#">${cartVo.goodsName}</a><br/>商品编号：21-255-244</td>
                                        <td class="red">￥${cartVo.marketPrice}</td>
                                        <td>￥0.00</td>
                                        <td>0</td>
                                        <td>${cartVo.goodsNum}</td>
                                        <td>当日出货</td>
                                    </tr>
                                </#list>
                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="" value="" id="" class="stext f-l"
                                                   style="width:227px;"/><a style="margin-left:10px;display:inline;"
                                                                            class="f-l" href="#"><img
                                                        src="${ctx}/images/shiyong.gif" width="62" height="24"
                                                        alt="使用"/></a>
                                            <div class="clear"></div>
                                ...
                                <table class="totable" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><strong
                                                    style="font-size:18px;color:#dc0000;">￥${cartResult.totalPrice}</strong></td>
                                    </tr>
                                    <tr>
